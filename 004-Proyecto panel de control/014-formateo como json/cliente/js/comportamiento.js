...
///////////////////////////// CONTENIDO DE LA TABLA ////////////////////////////////////
    ...
    function cargaTabla(tabla){                                     // Función que carga el contenido de una tabla
        ...
        .then(function(datos){                                      // Cuando el paso anterior haya sido completado
            ...
            titulo.textContent = "Insertar un nuevo registro en: "+globaltabla
            modal.appendChild(titulo)
            let seccion = document.createElement("div")
            seccion.setAttribute("class","doscolumnas")
            claves.forEach(function(clave){                         // Para cada una de las claves
                ...
                contenedor.setAttribute("class","grupoformulario")
                let texto = document.createElement("p")
                texto.textContent = "Introduce el contenido para : "+clave
                ...
                contenedor.appendChild(entrada)                          // Añado el campo al modal
                seccion.appendChild(contenedor)
                
            })
            modal.appendChild(seccion)
            ...
            datos.forEach(function(registro){                       // Para cada uno de los dato del json de entrada
                ...
                claves.forEach(function(clave){                     // Dentro de la fila, para cada una de las columnas
                    ...
                    nuevacelda.setAttribute("tabla",globaltabla)
                    nuevacelda.setAttribute("identificador",identificador)
                    nuevacelda.setAttribute("columna",clave)
                    nuevacelda.textContent = registro[clave]        // Le pongo el texto que corresponde a esa columna
                    nuevacelda.ondblclick = function(){
                        console.log("HAs hecho click en una celda")
                        this.setAttribute("contenteditable","true")
                        this.focus()
                    }
                    nuevacelda.onblur = function(){
                        console.log("Te has salido del campo")
                        this.setAttribute("contenteditable","false")
                        let valor = this.textContent
                        let mensaje = {}
                        mensaje.tabla = this.getAttribute("tabla")
                        mensaje.identificador = this.getAttribute("identificador")
                        mensaje.columna = this.getAttribute("columna")
                        mensaje.valor = valor;
                        console.log(mensaje)
                    }
