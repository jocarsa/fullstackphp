                ...
                .then(function(datos){
                    ...
                    fetch("../servidor/?o=insertar&tabla=pedidos", {     // lLamo a crear un nuevo registro
                        ...
                        .then(function(datos){
                            ...
                            let idpedido = datos.identificador  
                            carrito.forEach(function(productocarrito){
                                let mensajeproductocarrito = {}
                                ...
                                fetch("../servidor/?o=insertar&tabla=lineaspedido", {     // lLamo a crear un nuevo registro
                                  method: 'POST', 
                                  headers: {
                                    'Content-Type': 'application/json', 
                                  },
                        ...
                        setTimeout(function(){
                            destino.innerHTML = "👍<h3>Pedido correctamente realizado</h3>"
