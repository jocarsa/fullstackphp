window.onload = function(){
    ...
    document.querySelector("#selectorpedido").onchange = function(){
        cargaDatos(this.value)
    }
...
function cargaDatos(numeropedido){
    ...
    fetch("../servidor/datosdecliente.php?id="+numeropedido)
    ...
    fetch("../servidor/datosfactura.php?id="+numeropedido)
    .then(function(response){
        return response.json()
    })
    .then(function(datos){
    ...
    fetch("../servidor/lineasdepedido.php?id="+numeropedido)
    .then(function(response){
        return response.json()
    })
    .then(function(datos){
    ...
    fetch("../servidor/totalespedido.php?id="+numeropedido)
    .then(function(response){
        return response.json()
    })
    .then(function(datos){
